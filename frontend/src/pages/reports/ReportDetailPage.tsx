    ...
    <div className="p-4 sm:p-6 max-w-4xl mx-auto space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wide mb-1">Achievements / Highlights</p>
            {report.achievements?.trim()
              ? <p className="text-sm whitespace-pre-wrap">{report.achievements.trim()}</p>
              : <p className="text-sm text-muted-foreground italic">Not filled in</p>}
          </div>
        </CardContent>
      </Card>
